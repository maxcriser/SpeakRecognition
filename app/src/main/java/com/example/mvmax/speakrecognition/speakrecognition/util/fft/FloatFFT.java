...
import com.example.mvmax.speakrecognition.speakrecognition.util.ConcurrencyUtils;
...
public strictfp class FloatFFT {
    ...
    private void complexForward(final float[] a, final int offa) {
        if (n == 1) {
            return;
        }
        switch (plan) {
    ...
    public void complexInverse(final float[] a) {
        complexInverse(a, 0);
    }

    private void complexInverse(final float[] a, final int offa) {
        if (n == 1) {
            return;
        }
        switch (plan) {
    ...
    void realForward(final float[] a) {
        realForward(a, 0);
    }

    private void realForward(final float[] a, final int offa) {
        if (n == 1) {
            return;
        }
        ...
        switch (plan) {
            ...
            case MIXED_RADIX:
                rfftf(a, offa);
                for (int k = n - 1; k >= 2; k--) {
                    final int idx = offa + k;
                    final float tmp = a[idx];
                    a[idx] = a[idx - 1];
                    a[idx - 1] = tmp;
                }
                break;
    ...
    private static int getReminder(final int n, final int[] factors) {
        int reminder = n;
        ...
        for (k1 = 1; k1 <= nf; k1++) {
            ...
            for (j = 1; j <= ipm; j++) {
                ...
                for (ii = 4; ii <= idot; ii += 2) {
                    ...
                    arg = fi * argld;
                    final int idx = i + twon;
                    wtable[idx - 1] = (float) Math.cos(arg);
                    wtable[idx] = (float) Math.sin(arg);
                }
                if (ip > 5) {
                    final int idx1 = i1 + twon;
                    final int idx2 = i + twon;
    ...
    private void bluesteini() {
        ...
        final float scale = (float) (1.0 / nBluestein);
        bk2[0] = bk1[0] * scale;
        bk2[1] = bk1[1] * scale;
    ...
    private void makect(final int nc, final float[] c, final int startc) {
        int j;
        final int nch;
        final float delta;
        float deltaj;
                    ...
                    public void run() {
                        if (isign > 0) {
                            for (int i = firstIdx; i < lastIdx; i++) {
                                ...
                                final int idx3 = offa + idx1;
                                final int idx4 = offa + idx2;
                    ...
                    public void run() {
                        if (isign > 0) {
                            for (int i = firstIdx; i < lastIdx; i++) {
                                final int idx1 = 2 * i;
                                final int idx2 = idx1 + 1;
                                final float im = -ak[idx1] * bk2[idx2] + ak[idx2] * bk2[idx1];
    ...
    private void radf2(final int ido, final int l1, final float[] in, final int in_off, final float[] out, final int out_off, final int offset) {
        ...
        idx1 = 2 * ido;
        for (int k = 0; k < l1; k++) {
            final int oidx1 = out_off + k * idx1;
            final int oidx2 = oidx1 + idx1 - 1;
            final int iidx1 = in_off + k * ido;
            final int iidx2 = iidx1 + idx0;

            final float i1r = in[iidx1];
            final float i2r = in[iidx2];
        ...
        if (ido != 2) {
            for (int k = 0; k < l1; k++) {
                ...
                for (i = 2; i < ido; i += 2) {
                    ic = ido - i;
                    final int widx1 = i - 1 + iw1;
                    final int oidx1 = out_off + i + idx2;
                    final int oidx2 = out_off + ic + idx3;
                    final int iidx1 = in_off + i + idx1;
                    final int iidx2 = in_off + i + idx4;

                    final float a1i = in[iidx1 - 1];
                    final float a1r = in[iidx1];
                    final float a2i = in[iidx2 - 1];
                    final float a2r = in[iidx2];
        ...
        for (int k = 0; k < l1; k++) {
            idx1 = k * ido;
            final int oidx1 = out_off + idx2 + ido;
            final int iidx1 = in_off + ido - 1 + idx1;
    ...
    private void radf3(final int ido, final int l1, final float[] in, final int in_off, final float[] out, final int out_off, final int offset) {
        ...
        final int idx0 = l1 * ido;
        for (int k = 0; k < l1; k++) {
            final int idx1 = k * ido;
            final int idx3 = 2 * idx0;
            final int idx4 = (3 * k + 1) * ido;
            final int iidx1 = in_off + idx1;
            final int iidx2 = iidx1 + idx0;
            final int iidx3 = iidx1 + idx3;
            final float i1r = in[iidx1];
            final float i2r = in[iidx2];
            final float i3r = in[iidx3];
            cr2 = i2r + i3r;
        ...
        for (int k = 0; k < l1; k++) {
            final int idx3 = k * ido;
            final int idx4 = 3 * idx3;
            final int idx5 = idx3 + idx0;
            final int idx6 = idx5 + idx0;
            final int idx7 = idx4 + ido;
            final int idx8 = idx7 + ido;
            for (i = 2; i < ido; i += 2) {
                ic = ido - i;
                final int widx1 = i - 1 + iw1;
                final int widx2 = i - 1 + iw2;
                ...
                final int idx9 = in_off + i;
                final int idx10 = out_off + i;
                final int idx11 = out_off + ic;
                final int iidx1 = idx9 + idx3;
                final int iidx2 = idx9 + idx5;
                final int iidx3 = idx9 + idx6;

                final float i1i = in[iidx1 - 1];
                final float i1r = in[iidx1];
                final float i2i = in[iidx2 - 1];
                final float i2r = in[iidx2];
                final float i3i = in[iidx3 - 1];
                final float i3r = in[iidx3];
                ...
                final int oidx1 = idx10 + idx4;
                final int oidx2 = idx11 + idx7;
                final int oidx3 = idx10 + idx8;
    ...
    private void radf4(final int ido, final int l1, final float[] in, final int in_off, final float[] out, final int out_off, final int offset) {
        ...
        for (int k = 0; k < l1; k++) {
            final int idx1 = k * ido;
            final int idx2 = 4 * idx1;
            final int idx3 = idx1 + idx0;
            final int idx4 = idx3 + idx0;
            final int idx5 = idx4 + idx0;
            final int idx6 = idx2 + ido;
            final float i1r = in[in_off + idx1];
            final float i2r = in[in_off + idx3];
            final float i3r = in[in_off + idx4];
            final float i4r = in[in_off + idx5];

            tr1 = i2r + i4r;
            tr2 = i1r + i3r;

            final int oidx1 = out_off + idx2;
            final int oidx2 = out_off + idx6 + ido;
        ...
        if (ido != 2) {
            for (int k = 0; k < l1; k++) {
                final int idx1 = k * ido;
                final int idx2 = idx1 + idx0;
                final int idx3 = idx2 + idx0;
                final int idx4 = idx3 + idx0;
                final int idx5 = 4 * idx1;
                final int idx6 = idx5 + ido;
                final int idx7 = idx6 + ido;
                final int idx8 = idx7 + ido;
                for (i = 2; i < ido; i += 2) {
                    ic = ido - i;
                    final int widx1 = i - 1 + iw1;
                    final int widx2 = i - 1 + iw2;
                    final int widx3 = i - 1 + iw3;
                    w1r = wtable_r[widx1 - 1];
                    w1i = wtable_r[widx1];
                    w2r = wtable_r[widx2 - 1];
                    w2i = wtable_r[widx2];
                    ...
                    final int idx10 = out_off + i;
                    final int idx11 = out_off + ic;
                    final int iidx1 = idx9 + idx1;
                    final int iidx2 = idx9 + idx2;
                    final int iidx3 = idx9 + idx3;
                    final int iidx4 = idx9 + idx4;
                    ...
                    final float i3i = in[iidx3 - 1];
                    final float i3r = in[iidx3];
                    final float i4i = in[iidx4 - 1];
                    final float i4r = in[iidx4];
                    ...
                    final int oidx1 = idx10 + idx5;
                    final int oidx2 = idx11 + idx6;
                    final int oidx3 = idx10 + idx7;
                    final int oidx4 = idx11 + idx8;
        ...
        for (int k = 0; k < l1; k++) {
            ...
            final int idx7 = idx6 + ido;
            final int idx8 = idx7 + ido;
            final int idx9 = in_off + ido;
            final int idx10 = out_off + ido;

            final float i1i = in[idx9 - 1 + idx1];
            final float i2i = in[idx9 - 1 + idx3];
            final float i3i = in[idx9 - 1 + idx4];
            final float i4i = in[idx9 - 1 + idx5];
    ...
    private void radf5(final int ido, final int l1, final float[] in, final int in_off, final float[] out, final int out_off, final int offset) {
        ...
        for (int k = 0; k < l1; k++) {
            final int idx1 = k * ido;
            final int idx2 = 5 * idx1;
            final int idx3 = idx2 + ido;
            final int idx4 = idx3 + ido;
            final int idx5 = idx4 + ido;
            final int idx6 = idx5 + ido;
            final int idx7 = idx1 + idx0;
            final int idx8 = idx7 + idx0;
            final int idx9 = idx8 + idx0;
            final int idx10 = idx9 + idx0;
            final int idx11 = out_off + ido - 1;

            final float i1r = in[in_off + idx1];
            final float i2r = in[in_off + idx7];
            final float i3r = in[in_off + idx8];
            final float i4r = in[in_off + idx9];
            final float i5r = in[in_off + idx10];
        ...
        for (int k = 0; k < l1; ++k) {
            ...
            for (i = 2; i < ido; i += 2) {
                ...
                ic = ido - i;
                final int idx15 = in_off + i;
                final int idx16 = out_off + i;
                final int idx17 = out_off + ic;

                final int iidx1 = idx15 + idx1;
                final int iidx2 = idx15 + idx7;
                final int iidx3 = idx15 + idx8;
                final int iidx4 = idx15 + idx9;
                final int iidx5 = idx15 + idx10;
                ...
                final float i4i = in[iidx4 - 1];
                final float i4r = in[iidx4];
                final float i5i = in[iidx5 - 1];
                final float i5r = in[iidx5];
                ...
                final int oidx1 = idx16 + idx2;
                final int oidx2 = idx17 + idx3;
                final int oidx3 = idx16 + idx4;
                final int oidx4 = idx17 + idx5;
                final int oidx5 = idx16 + idx6;
    ...
    private void radfg(final int ido, final int ip, final int l1, final int idl1, final float[] in, final int in_off, final float[] out, final int out_off, final int offset) {
        ...
        if (ido != 1) {
            ...
            for (int j = 1; j < ip; j++) {
                final int idx1 = j * l1 * ido;
                for (int k = 0; k < l1; k++) {
                    final int idx2 = k * ido + idx1;
            ...
            if (nbd <= l1) {
                ...
                for (int j = 1; j < ip; j++) {
                    ...
                    for (int i = 2; i < ido; i += 2) {
                        idij += 2;
                        final int idx2 = idij + iw1;
                        final int idx4 = in_off + i;
                        final int idx5 = out_off + i;
                        w1r = wtable_r[idx2 - 1];
                        w1i = wtable_r[idx2];
                        for (int k = 0; k < l1; k++) {
                            final int idx3 = k * ido + idx1;
                            final int oidx1 = idx5 + idx3;
                            final int iidx1 = idx4 + idx3;
                            final float i1i = in[iidx1 - 1];
                            final float i1r = in[iidx1];
                ...
                for (int j = 1; j < ip; j++) {
                    ...
                    for (int k = 0; k < l1; k++) {
                        ...
                        for (int i = 2; i < ido; i += 2) {
                            ...
                            w1r = wtable_r[idx2 - 1];
                            w1i = wtable_r[idx2];
                            final int oidx1 = out_off + i + idx3;
                            final int iidx1 = in_off + i + idx3;
                            final float i1i = in[iidx1 - 1];
                            final float i1r = in[iidx1];
            ...
            if (nbd >= l1) {
                for (int j = 1; j < ipph; j++) {
                    jc = ip - j;
                    final int idx1 = j * l1 * ido;
                    final int idx2 = jc * l1 * ido;
                    for (int k = 0; k < l1; k++) {
                        final int idx3 = k * ido + idx1;
                        final int idx4 = k * ido + idx2;
                        for (int i = 2; i < ido; i += 2) {
                            final int idx5 = in_off + i;
                            final int idx6 = out_off + i;
                            final int iidx1 = idx5 + idx3;
                            final int iidx2 = idx5 + idx4;
                            final int oidx1 = idx6 + idx3;
                            final int oidx2 = idx6 + idx4;
                            final float o1i = out[oidx1 - 1];
                            final float o1r = out[oidx1];
                            final float o2i = out[oidx2 - 1];
                            final float o2r = out[oidx2];
        ...
        for (int j = 1; j < ipph; j++) {
            ...
            for (int k = 0; k < l1; k++) {
                final int idx3 = k * ido + idx1;
                final int idx4 = k * ido + idx2;
                final int oidx1 = out_off + idx3;
                final int oidx2 = out_off + idx4;
                final float o1r = out[oidx1];
                final float o2r = out[oidx2];
        ...
        ar1 = 1;
        ai1 = 0;
        final int idx0 = (ip - 1) * idl1;
        for (int l = 1; l < ipph; l++) {
            lc = ip - l;
            ar1h = dcp * ar1 - dsp * ai1;
            ai1 = dcp * ai1 + dsp * ar1;
            ar1 = ar1h;
            final int idx1 = l * idl1;
            final int idx2 = lc * idl1;
            for (int ik = 0; ik < idl1; ik++) {
                final int idx3 = out_off + ik;
                final int idx4 = in_off + ik;
            ...
            for (int j = 2; j < ipph; j++) {
                ...
                ai2 = dc2 * ai2 + ds2 * ar2;
                ar2 = ar2h;
                final int idx3 = j * idl1;
                final int idx4 = jc * idl1;
                for (int ik = 0; ik < idl1; ik++) {
                    final int idx5 = out_off + ik;
                    final int idx6 = in_off + ik;
        ...
        final int idx01 = ip * ido;
        for (int j = 1; j < ipph; j++) {
            jc = ip - j;
            j2 = 2 * j;
            final int idx1 = j * l1 * ido;
            final int idx2 = jc * l1 * ido;
            final int idx3 = j2 * ido;
            for (int k = 0; k < l1; k++) {
                final int idx4 = k * ido;
                final int idx5 = idx4 + idx1;
                final int idx6 = idx4 + idx2;
                final int idx7 = k * idx01;
        ...
        if (nbd >= l1) {
            for (int j = 1; j < ipph; j++) {
                ...
                final int idx3 = j2 * ido;
                for (int k = 0; k < l1; k++) {
                    final int idx4 = k * idx01;
                    final int idx5 = k * ido;
                    for (int i = 2; i < ido; i += 2) {
                        ic = ido - i;
                        final int idx6 = in_off + i;
                        final int idx7 = in_off + ic;
                        final int idx8 = out_off + i;
                        final int iidx1 = idx6 + idx3 + idx4;
                        final int iidx2 = idx7 + idx3 - ido + idx4;
                        final int oidx1 = idx8 + idx5 + idx1;
                        final int oidx2 = idx8 + idx5 + idx2;
                        final float o1i = out[oidx1 - 1];
                        final float o1r = out[oidx1];
                        final float o2i = out[oidx2 - 1];
                        final float o2r = out[oidx2];
    ...
    private void cfftf(final float[] a, final int offa, final int isign) {
        int idot;
        int l1, l2;
        int na;
        final int nf;
        ...
        int ido;
        int idl1;
        final int[] nac = new int[1];
        final int twon = 2 * n;

        final int iw1;
        final int iw2;
        final float[] ch = new float[twon];
    ...
    private void passf2(final int ido, final int l1, final float[] in, final int in_off, final float[] out, final int out_off, final int offset, final int isign) {
        ...
        final int iw1;
        iw1 = offset;
        final int idx = ido * l1;
        if (ido <= 2) {
            for (int k = 0; k < l1; k++) {
                final int idx0 = k * ido;
                final int iidx1 = in_off + 2 * idx0;
                final int iidx2 = iidx1 + ido;
                final float a1r = in[iidx1];
                final float a1i = in[iidx1 + 1];
                final float a2r = in[iidx2];
                final float a2i = in[iidx2 + 1];

                final int oidx1 = out_off + idx0;
                final int oidx2 = oidx1 + idx;
                out[oidx1] = a1r + a2r;
                out[oidx1 + 1] = a1i + a2i;
                out[oidx2] = a1r - a2r;
                out[oidx2 + 1] = a1i - a2i;
            ...
            for (int k = 0; k < l1; k++) {
                for (int i = 0; i < ido - 1; i += 2) {
                    final int idx0 = k * ido;
                    final int iidx1 = in_off + i + 2 * idx0;
                    final int iidx2 = iidx1 + ido;
                    final float i1r = in[iidx1];
                    final float i1i = in[iidx1 + 1];
                    final float i2r = in[iidx2];
                    ...
                    final int widx1 = i + iw1;
                    final float w1r = wtable[widx1];
                    final float w1i = isign * wtable[widx1 + 1];

                    t1r = i1r - i2r;
                    t1i = i1i - i2i;

                    final int oidx1 = out_off + i + idx0;
                    final int oidx2 = oidx1 + idx;
                    out[oidx1] = i1r + i2r;
                    out[oidx1 + 1] = i1i + i2i;
    ...
    private void passf3(final int ido, final int l1, final float[] in, final int in_off, final float[] out, final int out_off, final int offset, final int isign) {
        ...
        if (ido == 2) {
            for (int k = 1; k <= l1; k++) {
                final int iidx1 = in_off + (3 * k - 2) * ido;
                final int iidx2 = iidx1 + ido;
                final int iidx3 = iidx1 - ido;
                final float i1r = in[iidx1];
                final float i1i = in[iidx1 + 1];
                final float i2r = in[iidx2];
                final float i2i = in[iidx2 + 1];
                ...
                final int oidx1 = out_off + (k - 1) * ido;
                final int oidx2 = oidx1 + idxt;
                final int oidx3 = oidx2 + idxt;
            ...
            for (int k = 1; k <= l1; k++) {
                final int idx1 = in_off + (3 * k - 2) * ido;
                final int idx2 = out_off + (k - 1) * ido;
                for (int i = 0; i < ido - 1; i += 2) {
                    final int iidx1 = i + idx1;
                    final int iidx2 = iidx1 + ido;
                    final int iidx3 = iidx1 - ido;
                    final float a1r = in[iidx1];
                    final float a1i = in[iidx1 + 1];
                    final float a2r = in[iidx2];
                    final float a2i = in[iidx2 + 1];
                    final float a3r = in[iidx3];
                    final float a3i = in[iidx3 + 1];
                    ...
                    final int widx1 = i + iw1;
                    final int widx2 = i + iw2;
                    final float w1r = wtable[widx1];
                    final float w1i = isign * wtable[widx1 + 1];
                    final float w2r = wtable[widx2];
                    final float w2i = isign * wtable[widx2 + 1];

                    final int oidx1 = i + idx2;
                    final int oidx2 = oidx1 + idxt;
                    final int oidx3 = oidx2 + idxt;
                    out[oidx1] = a3r + tr2;
                    out[oidx1 + 1] = a3i + ti2;
    ...
    private void passf4(final int ido, final int l1, final float[] in, final int in_off, final float[] out, final int out_off, final int offset, final int isign) {
        ...
        if (ido == 2) {
            for (int k = 0; k < l1; k++) {
                final int idxt1 = k * ido;
                final int iidx1 = in_off + 4 * idxt1 + 1;
                final int iidx2 = iidx1 + ido;
                final int iidx3 = iidx2 + ido;
                final int iidx4 = iidx3 + ido;
                ...
                final int oidx1 = out_off + idxt1;
                final int oidx2 = oidx1 + idx0;
                final int oidx3 = oidx2 + idx0;
                final int oidx4 = oidx3 + idx0;
                out[oidx1] = tr2 + tr3;
                out[oidx1 + 1] = ti2 + ti3;
            ...
            for (int k = 0; k < l1; k++) {
                final int idx1 = k * ido;
                final int idx2 = in_off + 1 + 4 * idx1;
                for (int i = 0; i < ido - 1; i += 2) {
                    final int iidx1 = i + idx2;
                    final int iidx2 = iidx1 + ido;
                    final int iidx3 = iidx2 + ido;
                    final int iidx4 = iidx3 + ido;
                    final float i1i = in[iidx1 - 1];
                    ...
                    final int widx1 = i + iw1;
                    final int widx2 = i + iw2;
                    final int widx3 = i + iw3;
                    final float w1r = wtable[widx1];
                    final float w1i = isign * wtable[widx1 + 1];
                    final float w2r = wtable[widx2];
                    final float w2i = isign * wtable[widx2 + 1];
                    final float w3r = wtable[widx3];
                    final float w3i = isign * wtable[widx3 + 1];

                    final int oidx1 = out_off + i + idx1;
                    final int oidx2 = oidx1 + idx0;
                    final int oidx3 = oidx2 + idx0;
                    final int oidx4 = oidx3 + idx0;
                    out[oidx1] = tr2 + tr3;
    ...
    private void passf5(final int ido, final int l1, final float[] in, final int in_off, final float[] out, final int out_off, final int offset, final int isign) {
        ...
        if (ido == 2) {
            for (int k = 1; k <= l1; ++k) {
                final int iidx1 = in_off + (5 * k - 4) * ido + 1;
                final int iidx2 = iidx1 + ido;
                final int iidx3 = iidx1 - ido;
                final int iidx4 = iidx2 + ido;
                final int iidx5 = iidx4 + ido;
            ...
            for (int k = 1; k <= l1; k++) {
                final int idx1 = in_off + 1 + (k * 5 - 4) * ido;
                final int idx2 = out_off + (k - 1) * ido;
                for (int i = 0; i < ido - 1; i += 2) {
                    final int iidx1 = i + idx1;
                    final int iidx2 = iidx1 + ido;
                    ...
                    final float w3r = wtable[widx3];
                    final float w3i = isign * wtable[widx3 + 1];
                    final float w4r = wtable[widx4];
                    final float w4i = isign * wtable[widx4 + 1];
    ...
    private void passfg(final int[] nac, final int ido, final int ip, final int l1, final int idl1, final float[] in, final int in_off, final float[] out, final int out_off, final int offset, final int isign) {
        ...
        if (ido >= l1) {
            for (int j = 1; j < ipph; j++) {
                jc = ip - j;
                final int idx1 = j * ido;
                final int idx2 = jc * ido;
                for (int k = 0; k < l1; k++) {
                    final int idx3 = k * ido;
                    final int idx4 = idx3 + idx1 * l1;
                    final int idx5 = idx3 + idx2 * l1;
                    final int idx6 = idx3 * ip;
                    for (int i = 0; i < ido; i++) {
                        final int oidx1 = out_off + i;
                        final float i1r = in[in_off + i + idx1 + idx6];
                        final float i2r = in[in_off + i + idx2 + idx6];
            ...
            for (int j = 1; j < ipph; j++) {
                jc = ip - j;
                final int idxt1 = j * l1 * ido;
                final int idxt2 = jc * l1 * ido;
                final int idxt3 = j * ido;
                final int idxt4 = jc * ido;
                for (int i = 0; i < ido; i++) {
                    for (int k = 0; k < l1; k++) {
                        final int idx1 = k * ido;
                        final int idx2 = idx1 * ip;
                        final int idx3 = out_off + i;
                        final int idx4 = in_off + i;
                        final float i1r = in[idx4 + idxt3 + idx2];
                        final float i2r = in[idx4 + idxt4 + idx2];
        ...
        idl = 2 - ido;
        inc = 0;
        final int idxt0 = (ip - 1) * idl1;
        for (l = 1; l < ipph; l++) {
            lc = ip - l;
            idl += ido;
            final int idxt1 = l * idl1;
            final int idxt2 = lc * idl1;
            final int idxt3 = idl + iw1;
            w1r = wtable[idxt3 - 2];
            w1i = isign * wtable[idxt3 - 1];
            for (int ik = 0; ik < idl1; ik++) {
                final int idx1 = in_off + ik;
                final int idx2 = out_off + ik;
            ...
            for (int j = 2; j < ipph; j++) {
                ...
                final int idxt4 = idlj + iw1;
                w2r = wtable[idxt4 - 2];
                w2i = isign * wtable[idxt4 - 1];
                final int idxt5 = j * idl1;
                final int idxt6 = jc * idl1;
                for (int ik = 0; ik < idl1; ik++) {
                    final int idx1 = in_off + ik;
                    final int idx2 = out_off + ik;
        ...
        for (int j = 1; j < ipph; j++) {
            final int idxt1 = j * idl1;
            for (int ik = 0; ik < idl1; ik++) {
                final int idx1 = out_off + ik;
        ...
        for (int j = 1; j < ipph; j++) {
            jc = ip - j;
            final int idx1 = j * idl1;
            final int idx2 = jc * idl1;
            for (int ik = 1; ik < idl1; ik += 2) {
                final int idx3 = out_off + ik;
                final int idx4 = in_off + ik;
                final int iidx1 = idx4 + idx1;
                final int iidx2 = idx4 + idx2;
                final float i1i = in[iidx1 - 1];
                final float i1r = in[iidx1];
                final float i2i = in[iidx2 - 1];
                final float i2r = in[iidx2];

                final int oidx1 = idx3 + idx1;
                final int oidx2 = idx3 + idx2;
                out[oidx1 - 1] = i1i - i2r;
                out[oidx2 - 1] = i1i + i2r;
                out[oidx1] = i1r + i2i;
                out[oidx2] = i1r - i2i;
        ...
        final int idx0 = l1 * ido;
        for (int j = 1; j < ip; j++) {
            final int idx1 = j * idx0;
            for (int k = 0; k < l1; k++) {
                final int idx2 = k * ido;
                final int oidx1 = out_off + idx2 + idx1;
                final int iidx1 = in_off + idx2 + idx1;
                in[iidx1] = out[oidx1];
        ...
        if (idot <= l1) {
            ...
            for (int j = 1; j < ip; j++) {
                ...
                for (int i = 3; i < ido; i += 2) {
                    idij += 2;
                    final int idx2 = idij + iw1 - 1;
                    w1r = wtable[idx2 - 1];
                    w1i = isign * wtable[idx2];
                    final int idx3 = in_off + i;
                    final int idx4 = out_off + i;
                    for (int k = 0; k < l1; k++) {
                        final int idx5 = k * ido + idx1;
                        final int iidx1 = idx3 + idx5;
                        final int oidx1 = idx4 + idx5;
                        final float o1i = out[oidx1 - 1];
                        final float o1r = out[oidx1];
    ...
    private void cftfsub(final int n, final float[] a, final int offa, final int[] ip, final int nw, final float[] w) {
        if (n > 8) {
            if (n > 32) {
    ...
    private void cftbsub(final int n, final float[] a, final int offa, final int[] ip, final int nw, final float[] w) {
        if (n > 8) {
            if (n > 32) {
    ...
    private void bitrv2(final int n, final int[] ip, final float[] a, final int offa) {
        int j1;
        int k1;
        int l;
        int m;
    ...
    private void bitrv2conj(final int n, final int[] ip, final float[] a, final int offa) {
        int j1;
        int k1;
        int l;
        int m;
    ...
    private void bitrv216(final float[] a, final int offa) {
        final float x1r;
        final float x1i;
        final float x2r;
        final float x2i;
    ...
    private void bitrv216neg(final float[] a, final int offa) {
        final float x1r;
        final float x1i;
        final float x2r;
        final float x2i;
    ...
    private void bitrv208(final float[] a, final int offa) {
        final float x1r;
        final float x1i;
        final float x3r;
        final float x3i;
    ...
    private void bitrv208neg(final float[] a, final int offa) {
        final float x1r;
        final float x1i;
        final float x2r;
        final float x2i;
    ...
    private void cftf1st(final int n, final float[] a, final int offa, final float[] w, final int startw) {
        int j0;
        int j1;
        int j2;
        int j3;
    ...
    private void cftb1st(final int n, final float[] a, final int offa, final float[] w, final int startw) {
        int j0;
        int j1;
        int j2;
        int j3;
    ...
    private void cftfx41(final int n, final float[] a, final int offa, final int nw, final float[] w) {
        if (n == 128) {
            cftf161(a, offa, w, nw - 8);
            cftf162(a, offa + 32, w, nw - 32);
            cftf161(a, offa + 64, w, nw - 8);
    ...
    private void cftf040(final float[] a, final int offa) {
        final float x0r;
        final float x0i;
        final float x1r;
        final float x1i;
    ...
    private void cftb040(final float[] a, final int offa) {
        final float x0r;
        final float x0i;
        final float x1r;
        final float x1i;
    ...
    private void cftx020(final float[] a, final int offa) {
        final float x0r;
        final float x0i;
        x0r = a[offa] - a[offa + 2];
    ...
    private void cftxb020(final float[] a, final int offa) {
        final float x0r;
        final float x0i;
    ...
    private void rftfsub(final int n, final float[] a, final int offa, final int nc, final float[] c, final int startc) {
        int k;
        int kk;
        final int ks;
        final int m;
